            ...
            <MainFrame className="mb-20">
                <div>
                        ...
                        <div className="w-full md:max-w-1/2">
                            <div>
                                <ul className="space-y-2 md:space-y-4">
                                    <li className="text-md md:text-2xl font-bold">
                                        Web 開発エンジニア
                                    </li>
                    ...
                    <div className="ml-5 mt-2">
                            ...
                            <div className="w-full md:w-1/2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                            <div className="bg-yellow-600 h-2 rounded-full w-[70%]" />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex justify-between mb-1">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                            <div className="bg-green-600 h-2 rounded-full w-[90%]" />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex justify-between mb-1">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                            <div className="bg-red-600 h-2 rounded-full w-[95%]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="w-full md:w-1/2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                            <div className="bg-blue-400 h-2 rounded-full w-[65%]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="text-xl md:text-3xl font-bold mt-24">
                            スキルセット(資格系)
                        </div>
                        <h2 className="text-xl md:text-xl font-bold mb-3 mt-5 ml-7">
                            資格・認定
                        </h2>
